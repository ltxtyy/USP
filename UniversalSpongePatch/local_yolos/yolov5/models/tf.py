...
Usage:
    $ python local_yolos/tf.py --weights yolov5s.pt
...
def representative_dataset_gen(dataset, ncalib=100):
    # Representative bdd-dataset generator for use with converter.representative_dataset, returns a generator of np arrays
...
def run(
    ...
    LOGGER.info('PyTorch, TensorFlow and Keras local_yolos successfully verified.\nUse export.py for TF model export.')
